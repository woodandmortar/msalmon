...
const { shouldBehaveLikeERC20Base } = require('@woodandmortar/erc20-token/test/token/ERC20/behaviours/ERC20Base.behaviour'); // eslint-disable-line max-len
...
contract('BaseToken', function ([owner, anotherAccount, minter, operator, recipient, thirdParty]) {
  ...
  const _builtOn = {
    generator: 'https://salmonfund.github.io/solidity/',
    version: 'v3.1.0',
  };
